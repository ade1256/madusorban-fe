    ...
    <LayoutMobile>
        ...
        <div className="content">
          ...
          <div className="desc">
            ...
            <div className="text-center relative w-fit mx-auto my-0">
              ...
              <span className="text-white text-center text-xs not-italic font-normal leading-[normal]">
                atau
              </span>
              <button
                className="btn btn-link relative mx-auto my-0"
                onClick={() => handleClickBeli("")}
              >
                Beli via Whatsapp{" "}
      ...
      <div className="products">
        ...
        <p className="text-sm mt-2 text-center">
          Pilih menu di bawah untuk melihat lebih lanjut manfaat dan khasiat
          madu
        </p>
      ...
      <div className="about">
        <div className="info">
          ...
          <p>
            1. Madu Sorban adalah madu asli yang memiliki berbagai jenis varian
            dengan manfaat tertentu untuk menyembuhkan penyakit, menambah
            kesehatan, meningkatkan imunitas tubuh dan lain lain.
          </p>
          <p>
            2. Produk yang tersedia di atas memiliki manfaat yang berbeda, semua
            produk menggunakan bahan dasar madu asli tanpa campuran gula buatan
            sedikitpun sehingga sangat aman dikonsumsi dan bebas dari penyakit
            diabetes.
          </p>
          <p>
            3. Kualitas Madu Sorban justru dapat mencegah diabetes karena
            kandungan pada madu murni yang dapat menyembuhkan berbagai penyakit
            kronis seperti madu hitam yang dapat menyembuhkan diabetes, kanker,
            jantung koroner, stroke, dan lain lain.
          </p>
          <p>
            4. Silahkan klik menu produk untuk mengetahui manfaat lebih lanjut
            di setiap produk di atas.
          </p>
        </div>
        <div className="info">
          <h3>KANDUNGAN MADU</h3>
          <p>
            Kandungan zat yang terdapat pada madu adalah sebagai berikut
            Fruktosa, Glukosa, Maltosa, Sukrosa, Vitamin B2 B3 B9, lemak, air,
            zat besi, enzime, dan lainnya.
          </p>
        </div>
        <div className="info">
          <h3>CARA MENGETAHUI KEASLIAN MADU</h3>
          <p>
            1. Dengan meneteskan pada selembar kertas koran, maka madu asli akan
            lebih sulit terserap oleh kertas koran.
          </p>
          <p>
            2. Simpan madu dalam kantong plastik, plastik akan mengembung karena
            madu asli mengeluarkan gas.
          </p>
          <p>
            3. Dengan mengolesi kepala (belerang) korek api dengan madu, setelah
            1 jam seharusnya korek api akan tetap bisa menyala.
          </p>
          <p>
            4. Dengan mencampur 1 sdm madu dengan kuning telur ayam mentah,
            kuning telur akan mengental / mengkristal berbiji atau matang.
          </p>
          <p>
            5. Simpan madu dalam lemari freezer es, madu asli tidak akan beku
            dan hanya akan mengental.
          </p>
        </div>
      </div>
      <div className="">
        ...
        <div className="">
          <img
            src={ImageLab2.src}
            alt="Bukti laboratorium Madu Sorban Murni Halal"
          />
        </div>
        <div className="">
          <img
            src={ImageErick1.src}
            alt="Eric Thohir Membeli Madu Sorban bersama teman teman"
          />
        </div>
        <div className="">
